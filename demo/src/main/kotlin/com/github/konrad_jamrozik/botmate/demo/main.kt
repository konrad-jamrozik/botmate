...
private fun printHelp() {
  ...
  with(log) {
    ...
    info("           denoted by environment variable ${Button.serialPortEnvVar}. ")
    ...
    info("               denoted by environment variable ${RobotControllerAdapter.serialPortEnvVar}.")
    ...
    info("          ${RobotControllerAdapter.serialPortEnvVar} and ${Button.serialPortEnvVar} environment variables.")
    info("")
    info("--------------------")
    info("")
    info("Usage examples:")
