...
public class RXTXCommDriver implements CommDriver
{
  ...
  // Method call added by Konrad Jamrozik on 21 Apr 2016
  private final static boolean debug = System.getenv("RXTX_DEBUG") != null;
	...
	*/
    ...
    switch (PortType)
    {
      case CommPortIdentifier.PORT_SERIAL:
        ...
        // Edited by Konrad Jamrozik on 21 Apr 2016: Linux -> Linux-original
        if (osName.equals("Linux-original"))
        {
          String[] Temp = {
        ...
        // Edited by Konrad Jamrozik on 21 Apr 2016: Linux-all-ports -> Linux
